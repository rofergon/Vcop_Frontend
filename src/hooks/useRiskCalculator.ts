...
function getAssetSymbol(address: string): string | null {
  // Map addresses to symbols (should use environment variables)
  const addressToSymbol: Record<string, string> = {
    [import.meta.env.VITE_ETH_ADDRESS]: 'ETH',
    [import.meta.env.VITE_WBTC_ADDRESS]: 'WBTC',
    [import.meta.env.VITE_USDC_ADDRESS]: 'USDC',
    [import.meta.env.VITE_VCOP_ADDRESS]: 'VCOP',
  };
  
  return addressToSymbol[address] || null;
}
